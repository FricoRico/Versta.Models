...
my_dir = os.path.dirname(os.path.abspath(__file__)) + "/eng-nld/"  # path to the directory with the model and vocabularies
marian_npz = my_dir + "opus.spm32k-spm32k.transformer-align.model1.npz.best-perplexity.npz"            # path to the Marian model to convert
num_decoder_layers = 6                            # number of decoder layers
marian_vocs = [my_dir + "opus.spm32k-spm32k.vocab.yml"] * 2           # path to the vocabularies for source and target
onnx_model_path = my_dir + "model.onnx"  # resulting model gets written here
